...
random.wet <- rpoispp(length(wetland[,1]))
  ...
  plot(Kest(wetland))     # Ripley's K on observed process    
...
## Subset single pixel time-series observsation
...
## Temporal statistical aggretration 
